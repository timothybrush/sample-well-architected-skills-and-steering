...
- `steering/references/lenses/` — Additional lens-specific best practices (serverless, generative-ai, agentic-ai, responsible-ai, hybrid-networking, migration, devops-guidance, machine-learning, data-analytics, games-industry, saas, financial-services, life-sciences, end-user-computing, supply-chain, video-streaming-advertising, telco, sap, modern-industrial-data-technology, microsoft-workloads, connected-mobility, healthcare-industry, container-build, high-performance-computing, streaming-media)
